...
class Player {
    ...
    async init() {
        try {
            this.image = await this.loadImage('./img/spaceship.png');
            const scale = 0.08;
...
// Добавлен обработчик ошибок для загрузки изображений
window.addEventListener("error", (event) => {
    console.error("Error loading image:", event.message);
});

// Добавлен обработчик ошибок для других ошибок
